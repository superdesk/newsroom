...
function NavigationTab({navigations, activeNavigation, toggleNavigation, fetchItems, context}) {
    ...
    return navLinks.length > 1 && context === 'wire' ? [all].concat(navLinks) : navLinks;
}
