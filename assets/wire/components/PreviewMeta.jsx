...
import {gettext, getCount, isDisplayed, getCountLabel} from 'utils';
    ...
    return (
        <div className='wire-articles__item__meta'>
            ...
            <div className='wire-articles__item__meta-info'>
                ...
                {isDisplayed('word_count', displayConfig) && <span>{getCountLabel(true)}:<span> {getCount(item, displayConfig)}</span></span>}
