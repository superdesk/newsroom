...
var _reducers = __webpack_require__(635);

var _reducers2 = _interopRequireDefault(_reducers);

var _UserProfileApp = __webpack_require__(636);
...
var _FollowedTopics = __webpack_require__(637);

var _FollowedTopics2 = _interopRequireDefault(_FollowedTopics);

var _UserProfileMenu = __webpack_require__(638);

var _UserProfileMenu2 = _interopRequireDefault(_UserProfileMenu);

var _UserProfileAvatar = __webpack_require__(639);
...
var _UserProfile = __webpack_require__(641);

var _UserProfile2 = _interopRequireDefault(_UserProfile);

var _ProfileToggle = __webpack_require__(642);
...
var UserProfileApp = function (_React$Component) {
    ...
    function UserProfileApp(props, context) {
        ...
        _this.state = { dropdown: false, modal: false, selectedMenu: 'profile' };
        _this.links = [{
            name: 'profile',
    ...
    _createClass(UserProfileApp, [{
        key: 'selectMenu',
        value: function selectMenu(selectedMenu) {
        ...
        value: function renderProfile() {
            ...
            var links = this.links.map(function (link) {
                link.active = link.name === _this2.state.selectedMenu;
                return link;
            });
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'button',
                            { className: 'icon-button', onClick: this.close },
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        'span',
                                        { className: 'content-bar__menu', onClick: this.close },
        ...
        value: function render() {
            ...
            var profile = _reactDom2.default.createPortal(this.state.modal ? this.renderProfile() : null, document.getElementById('user-profile-app'));

            var dropdown = this.state.dropdown && _react2.default.createElement(
                'div',
            ...
            return [_react2.default.createElement(_ProfileToggle2.default, { key: 'toggle',
                ...
                onClick: function onClick() {
                    return _this3.setState({ dropdown: !_this3.state.dropdown });
                }
            }), dropdown, profile];
        }
    }]);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    return {
        selectMenu: function selectMenu(event) {
            return dispatch((0, _actions.updateMenu)(event));
        }
    };
};
