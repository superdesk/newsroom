...
exports.SET_ERROR = exports.UPDATE_PRODUCT_NAVIGATIONS = exports.UPDATE_PRODUCT_COMPANIES = exports.GET_NAVIGATIONS = exports.GET_COMPANIES = exports.GET_PRODUCTS = exports.QUERY_PRODUCTS = exports.SET_QUERY = exports.CANCEL_EDIT = exports.NEW_PRODUCT = exports.EDIT_PRODUCT = exports.SELECT_PRODUCT = undefined;
...
exports.updateProductCompanies = updateProductCompanies;
exports.updateProductNavigations = updateProductNavigations;
...
exports.saveNavigations = saveNavigations;
...
function selectProduct(id) {
    return { type: SELECT_PRODUCT, id: id };
}

var EDIT_PRODUCT = exports.EDIT_PRODUCT = 'EDIT_PRODUCT';
function editProduct(event) {
    return { type: EDIT_PRODUCT, event: event };
}

var NEW_PRODUCT = exports.NEW_PRODUCT = 'NEW_PRODUCT';
function newProduct() {
...
var QUERY_PRODUCTS = exports.QUERY_PRODUCTS = 'QUERY_PRODUCTS';
...
function getCompanies(data) {
    return { type: GET_COMPANIES, data: data };
}
...
var UPDATE_PRODUCT_COMPANIES = exports.UPDATE_PRODUCT_COMPANIES = 'UPDATE_PRODUCT_COMPANIES';
function updateProductCompanies(product, companies) {
    return { type: UPDATE_PRODUCT_COMPANIES, product: product, companies: companies };
}

var UPDATE_PRODUCT_NAVIGATIONS = exports.UPDATE_PRODUCT_NAVIGATIONS = 'UPDATE_PRODUCT_NAVIGATIONS';
function updateProductNavigations(product, navigations) {
    return { type: UPDATE_PRODUCT_NAVIGATIONS, product: product, navigations: navigations };
}
...
function fetchProducts() {
    return function (dispatch, getState) {
        ...
        return _server2.default.get('/products/search?q=' + query).then(function (data) {
...
function postProduct() {
    return function (dispatch, getState) {
        ...
        var product = getState().productToEdit;
        var url = '/products/' + (product._id ? product._id : 'new');

        return _server2.default.post(url, product).then(function () {
            if (product._id) {
                _utils.notify.success((0, _utils.gettext)('Product updated successfully'));
            } else {
                _utils.notify.success((0, _utils.gettext)('Product created successfully'));
            }
...
function deleteProduct() {
    return function (dispatch, getState) {
        ...
        return _server2.default.del(url).then(function () {
            _utils.notify.success((0, _utils.gettext)('Product deleted successfully'));
            dispatch(fetchProducts());
        }).catch(function (error) {
            return (0, _utils.errorHandler)(error, dispatch, setError);
        });
...
function fetchCompanies() {
    return function (dispatch) {
        return _server2.default.get('/companies/search').then(function (data) {
...
function saveCompanies(companies) {
    return function (dispatch, getState) {
        var product = getState().productToEdit;
        return _server2.default.post('/products/' + product._id + '/companies', { companies: companies }).then(function () {
            _utils.notify.success((0, _utils.gettext)('Product updated successfully'));
...
function fetchNavigations() {
    return function (dispatch) {
        return _server2.default.get('/navigations/search').then(function (data) {
 ...
 *
 */
function saveNavigations(navigations) {
    return function (dispatch, getState) {
        var product = getState().productToEdit;
        return _server2.default.post('/products/' + product._id + '/navigations', { navigations: navigations }).then(function () {
            _utils.notify.success((0, _utils.gettext)('Product updated successfully'));
...
var _ProductsApp = __webpack_require__(612);
...
(0, _utils.render)(store, _ProductsApp2.default, document.getElementById('settings-app'));
...
function productReducer() {
    ...
    switch (action.type) {
        ...
        case _actions.EDIT_PRODUCT:
            {
                var target = action.event.target;
                var field = target.name;
                var product = state.productToEdit;
                product[field] = target.type === 'checkbox' ? target.checked : target.value;
                return _extends({}, state, { productToEdit: product, errors: null });
            }

        case _actions.NEW_PRODUCT:
            {
                var productToEdit = {
                    is_enabled: true,
                    name: '',
                ...
                return _extends({}, state, { productToEdit: productToEdit, errors: null });
            }

        case _actions.CANCEL_EDIT:
            {
                return _extends({}, state, { productToEdit: null, errors: null });
            }
        ...
        case _actions.GET_PRODUCTS:
            {
                var productsById = Object.assign({}, state.productsById);
                var products = action.data.map(function (product) {
                    productsById[product._id] = product;
                    return product._id;
                });

                return _extends({}, state, { products: products, productsById: productsById, isLoading: false, totalProducts: products.length });
            }

        case _actions.GET_COMPANIES:
            {
                var companiesById = {};
                action.data.map(function (company) {
                    return companiesById[company._id] = company;
                });

                return _extends({}, state, { companies: action.data, companiesById: companiesById });
            }

        case _actions.GET_NAVIGATIONS:
            {
                var navigationsById = {};
                action.data.map(function (navigation) {
                    return navigationsById[navigation._id] = navigation;
                });

                return _extends({}, state, { navigations: action.data, navigationsById: navigationsById });
            }

        case _actions.UPDATE_PRODUCT_COMPANIES:
            {
                var _product = Object.assign({}, action.product, { companies: action.companies });
                var _productsById = Object.assign({}, state.productsById);
                _productsById[action.product._id] = _product;

                return _extends({}, state, { productsById: _productsById, productToEdit: _product });
            }

        case _actions.UPDATE_PRODUCT_NAVIGATIONS:
            {
                var _product2 = Object.assign({}, action.product, { navigations: action.navigations });
                var _productsById2 = Object.assign({}, state.productsById);
                _productsById2[action.product._id] = _product2;

                return _extends({}, state, { productsById: _productsById2, productToEdit: _product2 });
            }
...
var _Products = __webpack_require__(613);

var _Products2 = _interopRequireDefault(_Products);

var _ListBar = __webpack_require__(78);
...
var ProductsApp = function (_React$Component) {
    _inherits(ProductsApp, _React$Component);

    function ProductsApp(props, context) {
        _classCallCheck(this, ProductsApp);

        return _possibleConstructorReturn(this, (ProductsApp.__proto__ || Object.getPrototypeOf(ProductsApp)).call(this, props, context));
    }
    ...
    _createClass(ProductsApp, [{
        ...
        value: function render() {
            return [_react2.default.createElement(_ListBar2.default, {
                ...
                buttonName: 'Product'
            }), _react2.default.createElement(_Products2.default, { key: 'Products' })];
        }
    }]);
...
ProductsApp.propTypes = {
    ...
    productToEdit: _propTypes2.default.object,
    activeProductId: _propTypes2.default.string,
    selectProduct: _propTypes2.default.func,
    editProduct: _propTypes2.default.func,
    saveProduct: _propTypes2.default.func,
    deleteProduct: _propTypes2.default.func,
    newProduct: _propTypes2.default.func,
    cancelEdit: _propTypes2.default.func,
    isLoading: _propTypes2.default.bool,
    activeQuery: _propTypes2.default.string,
    totalProducts: _propTypes2.default.number,
    companies: _propTypes2.default.arrayOf(_propTypes2.default.object),
    companiesById: _propTypes2.default.object,
    productsById: _propTypes2.default.object,
...
var mapDispatchToProps = {
    ...
    newProduct: _actions.newProduct
};

exports.default = (0, _reactRedux.connect)(null, mapDispatchToProps)(ProductsApp);
...
var _EditProduct = __webpack_require__(614);

var _EditProduct2 = _interopRequireDefault(_EditProduct);

var _ProductList = __webpack_require__(615);
...
var Products = function (_React$Component) {
    ...
    _createClass(Products, [{
        ...
        value: function deleteProduct(event) {
            ...
            if (confirm((0, _utils.gettext)('Would you like to delete product: {{name}}', { name: this.props.productToEdit.name }))) {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                this.props.productToEdit && _react2.default.createElement(_EditProduct2.default, {
...
Products.propTypes = {
    ...
    activeQuery: _propTypes2.default.string,
    totalProducts: _propTypes2.default.number,
    fetchCompanies: _propTypes2.default.func,
    fetchNavigations: _propTypes2.default.func,
    errors: _propTypes2.default.object,
    dispatch: _propTypes2.default.func,
    companies: _propTypes2.default.arrayOf(_propTypes2.default.object),
    navigations: _propTypes2.default.arrayOf(_propTypes2.default.object),
    saveCompanies: _propTypes2.default.func.isRequired,
    saveNavigations: _propTypes2.default.func.isRequired
};

var mapStateToProps = function mapStateToProps(state) {
    return {
        products: state.products.map(function (id) {
            return state.productsById[id];
        }),
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    return {
        selectProduct: function selectProduct(_id) {
            return dispatch((0, _actions.selectProduct)(_id));
        },
        editProduct: function editProduct(event) {
            return dispatch((0, _actions.editProduct)(event));
        },
        saveProduct: function saveProduct(type) {
            return dispatch((0, _actions.postProduct)(type));
        },
        deleteProduct: function deleteProduct(type) {
            return dispatch((0, _actions.deleteProduct)(type));
        },
        newProduct: function newProduct() {
            return dispatch((0, _actions.newProduct)());
        },
        saveCompanies: function saveCompanies(companies) {
            return dispatch((0, _actions.saveCompanies)(companies));
        },
        fetchCompanies: function fetchCompanies() {
            return dispatch((0, _actions.fetchCompanies)());
        },
        saveNavigations: function saveNavigations(navigations) {
            return dispatch((0, _actions.saveNavigations)(navigations));
        },
        fetchNavigations: function fetchNavigations() {
            return dispatch((0, _actions.fetchNavigations)());
        },
...
var _EditPanel = __webpack_require__(106);
...
var EditProduct = function (_React$Component) {
    ...
    function EditProduct(props) {
        ...
        _this.getPoductTestButton = _this.getPoductTestButton.bind(_this);
        _this.state = {
            activeTab: 'product-details',
            activeProduct: props.product._id
        };

        _this.tabs = [{ label: (0, _utils.gettext)('Product'), name: 'product-details' }, { label: (0, _utils.gettext)('Companies'), name: 'companies' }, { label: (0, _utils.gettext)('Navigations'), name: 'navigations' }];
        return _this;
    }
    ...
    _createClass(EditProduct, [{
        ...
        key: 'getPoductTestButton',
        value: function getPoductTestButton(product) {
            var q = (0, _utils.getProductQuery)(product);

            if (q) {
                return _react2.default.createElement(
                    'a',
                    { href: '/wire?q=' + q, target: '_blank',
                        className: 'btn btn-outline-secondary float-right' },
                    (0, _utils.gettext)('Test product')
                );
            }
        }
    }, {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                    ...
                    this.tabs.map(function (tab) {
                        return _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                {
                                    name: tab.name,
                                    className: 'nav-link ' + (_this2.state.activeTab === tab.name && 'active'),
                                    href: '#',
                ...
                _react2.default.createElement(
                    ...
                    this.state.activeTab === 'product-details' && _react2.default.createElement(
                        'div',
                        { className: 'tab-pane active', id: 'product-details' },
                        _react2.default.createElement(
                            'form',
                            null,
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        'label',
                                        { htmlFor: 'sd_product_id' },
                                        (0, _utils.gettext)('Superdesk Product Id')
                                    ),
                                    ...
                                    this.props.product.sd_product_id && _react2.default.createElement(
                                        'a',
                                        { href: '/wire?q=products.code:' + this.props.product.sd_product_id, target: '_blank',
                                            className: 'btn btn-outline-secondary float-right mt-2' },
                                        (0, _utils.gettext)('Test product id')
                                    )
                                ),
                                _react2.default.createElement(
                                    'div',
                                    ...
                                    this.props.product.query && _react2.default.createElement(
                                        'a',
                                        { href: '/wire?q=' + this.props.product.query, target: '_blank',
                                            className: 'btn btn-outline-secondary float-right mt-3' },
                                        (0, _utils.gettext)('Test query')
                                    )
                                ),
                                _react2.default.createElement(_CheckboxInput2.default, {
                                    name: 'is_enabled',
                    ...
                    this.state.activeTab === 'companies' && _react2.default.createElement(_EditPanel2.default, {
                        parent: this.props.product,
                        items: this.props.companies,
                        field: 'companies',
                        onSave: this.props.saveCompanies
                    }),
                    this.state.activeTab === 'navigations' && _react2.default.createElement(_EditPanel2.default, {
                        parent: this.props.product,
...
EditProduct.propTypes = {
    ...
    saveCompanies: _propTypes2.default.func.isRequired,
    saveNavigations: _propTypes2.default.func.isRequired,
    fetchCompanies: _propTypes2.default.func.isRequired,
    fetchNavigations: _propTypes2.default.func.isRequired
};
...
var _ProductListItem = __webpack_require__(616);
...
function ProductList(_ref) {
    var products = _ref.products,
        ...
        activeProductId = _ref.activeProductId;
...
function ProductListItem(_ref) {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            'td',
            null,
            product.is_enabled ? (0, _utils.gettext)('Enabled') : (0, _utils.gettext)('Disabled')
        ),
        _react2.default.createElement(
            'td',
            null,
            (0, _utils.gettext)(product.sd_product_id)
        ),
        _react2.default.createElement(
            'td',
            null,
            (0, _utils.gettext)(product.query)
        ),
        _react2.default.createElement(
            'td',
            null,
            (0, _utils.shortDate)(product._created)
        )
    );
}
