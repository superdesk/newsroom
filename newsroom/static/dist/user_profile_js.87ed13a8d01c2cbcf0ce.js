...
var ProfileToggle = function (_React$Component) {
    _inherits(ProfileToggle, _React$Component);

    function ProfileToggle() {
        _classCallCheck(this, ProfileToggle);

        return _possibleConstructorReturn(this, (ProfileToggle.__proto__ || Object.getPrototypeOf(ProfileToggle)).apply(this, arguments));
    }

    _createClass(ProfileToggle, [{
        ...
        value: function render() {
            ...
            var initials = this.props.user.first_name[0].toLocaleUpperCase() + this.props.user.last_name[0].toLocaleUpperCase();
