...
var WireApp = function (_React$Component) {
    ...
    _createClass(WireApp, [{
        ...
        value: function render() {
            ...
            var searchCriteria = (0, _utils2.getActiveQuery)(this.props.activeQuery, this.props.activeFilter, this.props.createdFilter);
            var activeTopic = this.props.topics.find(function (topic) {
                return (0, _utils2.isTopicActive)(topic, searchCriteria);
            });
            ...
            return (this.props.itemToOpen ? [_react2.default.createElement(_ItemDetails2.default, { key: 'itemDetails',
                ...
                _react2.default.createElement(
                    ...
                    this.state.withSidebar && _react2.default.createElement(
                        'span',
                        {
                            className: 'content-bar__menu content-bar__menu--nav--open',
                            ref: function ref(elem) {
                                return _this3.elemOpen = elem;
                            },
                            title: (0, _utils.gettext)('Close filter panel'),
                            onClick: this.toggleSidebar },
                        _react2.default.createElement('i', { className: 'icon--close-thin icon--white' })
                    ),
                    !this.state.withSidebar && _react2.default.createElement(
                        'span',
                        {
                            ...
                            ref: function ref(elem) {
                                return _this3.elemClose = elem;
                            },
                            title: (0, _utils.gettext)('Open filter panel'),
                            onClick: this.toggleSidebar },
...
var SearchSidebar = function (_React$Component) {
    ...
    function SearchSidebar(props) {
        ...
        _this.state = { active: (0, _utils2.getActiveFilterTab)() || _this.tabs[0].label };
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    this.tabs.map(function (tab) {
                        return _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'a',
                                { className: 'nav-link ' + (_this2.state.active === tab.label && 'active'),
                                    role: 'tab',
                                    href: '',
                                    onClick: function onClick(event) {
                                        event.preventDefault();
                                        (0, _utils2.setActiveFilterTab)(tab.label);
                                        _this2.setState({ active: tab.label });
                                    } },
                                tab.label
                            )
                        );
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: (0, _classnames2.default)('tab-pane', 'fade', { 'show active': this.state.active === this.tabs[0].label }), role: 'tabpanel' },
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: (0, _classnames2.default)('tab-pane', 'fade', { 'show active': this.state.active === this.tabs[1].label }), role: 'tabpanel' },
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: (0, _classnames2.default)('tab-pane', 'fade', { 'show active': this.state.active === this.tabs[2].label }), role: 'tabpanel' },
...
var FiltersTab = function (_React$Component) {
    ...
    function FiltersTab(props) {
        ...
        _this.state = { groups: [{
                ...
                field: 'genre',
                label: (0, _utils.gettext)('Content Type')
            }, {
                field: 'urgency',
...
function NavCreatedPicker(_ref) {
    ...
    return _react2.default.createElement(
        _NavGroup2.default,
        { label: (0, _utils.gettext)('Published') },
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'span',
                        {
                            ...
                            title: (0, _utils.gettext)('Change view') },
