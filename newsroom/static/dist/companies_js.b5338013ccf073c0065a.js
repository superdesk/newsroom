...
exports.INIT_VIEW_DATA = exports.SET_ERROR = exports.GET_PRODUCTS = exports.GET_COMPANY_USERS = exports.GET_COMPANIES = exports.QUERY_COMPANIES = exports.SET_QUERY = exports.CANCEL_EDIT = exports.NEW_COMPANY = exports.EDIT_COMPANY = exports.SELECT_COMPANY = undefined;
...
var SELECT_COMPANY = exports.SELECT_COMPANY = 'SELECT_COMPANY';
...
function select(id) {
    return { type: SELECT_COMPANY, id: id };
}

var EDIT_COMPANY = exports.EDIT_COMPANY = 'EDIT_COMPANY';
function editCompany(event) {
    return { type: EDIT_COMPANY, event: event };
}

var NEW_COMPANY = exports.NEW_COMPANY = 'NEW_COMPANY';
function newCompany(data) {
    return { type: NEW_COMPANY, data: data };
}
...
var QUERY_COMPANIES = exports.QUERY_COMPANIES = 'QUERY_COMPANIES';
...
var GET_COMPANY_USERS = exports.GET_COMPANY_USERS = 'GET_COMPANY_USERS';
function getCompanyUsers(data) {
    return { type: GET_COMPANY_USERS, data: data };
}
...
function fetchCompanies() {
    return function (dispatch, getState) {
        ...
        return _server2.default.get('/companies/search?q=' + query).then(function (data) {
...
function fetchCompanyUsers(companyId) {
    return function (dispatch, getState) {
        ...
        return _server2.default.get('/companies/' + companyId + '/users').then(function (data) {
...
function postCompany() {
    return function (dispatch, getState) {
        ...
        var company = getState().companyToEdit;
        var url = '/companies/' + (company._id ? company._id : 'new');

        return _server2.default.post(url, company).then(function () {
            if (company._id) {
                _utils.notify.success((0, _utils.gettext)('Company updated successfully'));
            } else {
                _utils.notify.success((0, _utils.gettext)('Company created successfully'));
            }
...
function saveProducts(products) {
    return function (dispatch, getState) {
        var company = getState().companyToEdit;
        return _server2.default.post('/companies/' + company._id + '/products', { products: products }).then(function () {
            _utils.notify.success((0, _utils.gettext)('Company updated successfully'));
...
function deleteCompany() {
    return function (dispatch, getState) {
        ...
        var company = getState().companyToEdit;
        var url = '/companies/' + company._id;

        return _server2.default.del(url).then(function () {
            _utils.notify.success((0, _utils.gettext)('Company deleted successfully'));
            dispatch(fetchCompanies());
        }).catch(function (error) {
            return (0, _utils.errorHandler)(error, dispatch, setError);
        });
...
var INIT_VIEW_DATA = exports.INIT_VIEW_DATA = 'INIT_VIEW_DATA';
...
var _CompaniesApp = __webpack_require__(598);

var _CompaniesApp2 = _interopRequireDefault(_CompaniesApp);
...
(0, _utils.render)(store, _CompaniesApp2.default, document.getElementById('settings-app'));
...
function companyReducer() {
    ...
    switch (action.type) {
        ...
        case _actions.EDIT_COMPANY:
            {
                var target = action.event.target;
                var field = target.name;
                var company = state.companyToEdit;
                company[field] = target.type === 'checkbox' ? target.checked : target.value;
                return _extends({}, state, { companyToEdit: company, errors: null });
            }

        case _actions.NEW_COMPANY:
            {
                var newUser = {
                    user_type: 'public',
                    is_approved: true,
                ...
                return _extends({}, state, { companyToEdit: action.data === 'users' ? newUser : newCompany, errors: null });
            }

        case _actions.CANCEL_EDIT:
            {
                return _extends({}, state, { companyToEdit: null, errors: null });
            }
        ...
        case _actions.GET_COMPANIES:
            {
                var companiesById = {};
                var companyOptions = [];
                var companies = action.data.map(function (company) {
                    companiesById[company._id] = company;
                    companyOptions.push({ value: company._id, text: company.name });
                    return company._id;
                });

                return _extends({}, state, { companies: companies, companiesById: companiesById, companyOptions: companyOptions, isLoading: false });
            }

        case _actions.GET_COMPANY_USERS:
            {
                return _extends({}, state, { companyUsers: action.data });
            }

        case _actions.GET_PRODUCTS:
            return _extends({}, state, { products: action.data });

        case _actions.INIT_VIEW_DATA:
            return _extends({}, state, { services: action.data.services, products: action.data.products });
...
var _Companies = __webpack_require__(599);
...
var CompaniesApp = function (_React$Component) {
    _inherits(CompaniesApp, _React$Component);

    function CompaniesApp(props, context) {
        _classCallCheck(this, CompaniesApp);

        return _possibleConstructorReturn(this, (CompaniesApp.__proto__ || Object.getPrototypeOf(CompaniesApp)).call(this, props, context));
    }

    _createClass(CompaniesApp, [{
        key: 'render',
        value: function render() {
            return [_react2.default.createElement(_ListBar2.default, {
                ...
                buttonName: 'Company'
            }), _react2.default.createElement(_Companies2.default, { key: 'Companies' })];
        }
    }]);
...
CompaniesApp.propTypes = {
    ...
    companyToEdit: _propTypes2.default.object,
    activeCompanyId: _propTypes2.default.string,
    selectCompany: _propTypes2.default.func,
    editCompany: _propTypes2.default.func,
    saveCompany: _propTypes2.default.func,
    deleteCompany: _propTypes2.default.func,
    newCompany: _propTypes2.default.func,
    cancelEdit: _propTypes2.default.func,
    isLoading: _propTypes2.default.bool,
    activeQuery: _propTypes2.default.string,
    totalCompanies: _propTypes2.default.number,
    companyOptions: _propTypes2.default.arrayOf(_propTypes2.default.object),
    companiesById: _propTypes2.default.object,
    companyUsers: _propTypes2.default.arrayOf(_propTypes2.default.object),
    fetchCompanies: _propTypes2.default.func,
    fetchCompanyUsers: _propTypes2.default.func,
...
var mapDispatchToProps = {
    newCompany: _actions.newCompany,
    fetchCompanies: _actions.fetchCompanies,
    setQuery: _actions.setQuery
};

exports.default = (0, _reactRedux.connect)(null, mapDispatchToProps)(CompaniesApp);
...
var _EditCompany = __webpack_require__(600);

var _EditCompany2 = _interopRequireDefault(_EditCompany);

var _CompanyList = __webpack_require__(601);
...
var Companies = function (_React$Component) {
    ...
    function Companies(props, context) {
        _classCallCheck(this, Companies);

        var _this = _possibleConstructorReturn(this, (Companies.__proto__ || Object.getPrototypeOf(Companies)).call(this, props, context));
    ...
    _createClass(Companies, [{
        ...
        value: function deleteCompany(event) {
            ...
            if (confirm((0, _utils.gettext)('Would you like to delete company: {{name}}', { name: this.props.companyToEdit.name }))) {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                this.props.isLoading ? _react2.default.createElement(
                    ...
                    _react2.default.createElement(_CompanyList2.default, {
                        companies: this.props.companies,
                        onClick: this.props.selectCompany,
                        activeCompanyId: this.props.activeCompanyId })
                ),
                this.props.companyToEdit && _react2.default.createElement(_EditCompany2.default, {
...
var mapStateToProps = function mapStateToProps(state) {
    return {
        companies: state.companies.map(function (id) {
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    return {
        selectCompany: function selectCompany(id) {
            return dispatch((0, _actions.selectCompany)(id));
        },
        editCompany: function editCompany(event) {
            return dispatch((0, _actions.editCompany)(event));
        },
        saveCompany: function saveCompany() {
            return dispatch((0, _actions.postCompany)());
        },
        deleteCompany: function deleteCompany() {
            return dispatch((0, _actions.deleteCompany)());
        },
        cancelEdit: function cancelEdit(event) {
            return dispatch((0, _actions.cancelEdit)(event));
        },
        fetchCompanyUsers: function fetchCompanyUsers(companyId) {
            return dispatch((0, _actions.fetchCompanyUsers)(companyId));
        },
...
var countries = [{ value: 'au', text: (0, _utils.gettext)('Australia') }, { value: 'nz', text: (0, _utils.gettext)('New Zealand') }, { value: 'other', text: (0, _utils.gettext)('Other') }];

var EditCompany = function (_React$Component) {
    _inherits(EditCompany, _React$Component);

    function EditCompany(props) {
        _classCallCheck(this, EditCompany);

        var _this = _possibleConstructorReturn(this, (EditCompany.__proto__ || Object.getPrototypeOf(EditCompany)).call(this, props));

        _this.handleTabClick = _this.handleTabClick.bind(_this);
        _this.getCompanyProducts = _this.getCompanyProducts.bind(_this);
        _this.getUsers = _this.getUsers.bind(_this);
        _this.state = { activeTab: 'company-details' };
        _this.tabs = [{ label: (0, _utils.gettext)('Company'), name: 'company-details' }, { label: (0, _utils.gettext)('Users'), name: 'users' }, { label: (0, _utils.gettext)('Products'), name: 'products' }];
        return _this;
    }
    ...
    _createClass(EditCompany, [{
                ...
                return this.props.users.map(function (user) {
                    return _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'td',
                            null,
                            (0, _utils.shortDate)(user._created)
                        )
                    );
                });
            }
        ...
        key: 'getCompanyProducts',
        value: function getCompanyProducts() {
            var _this2 = this;

            var products = this.props.products.filter(function (product) {
                return product.companies && product.companies.includes(_this2.props.company._id);
            }).map(function (p) {
                return p._id;
            });

            return { _id: this.props.company._id, products: products };
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    this.state.activeTab === 'company-details' && _react2.default.createElement(
                        'div',
                        { className: 'tab-pane active', id: 'company-details' },
                        _react2.default.createElement(
                            'form',
                            null,
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(_SelectInput2.default, {
                                    name: 'country',
                                    label: (0, _utils.gettext)('Country'),
                            ...
                            _react2.default.createElement(
                                ...
                                this.props.company._id && _react2.default.createElement('input', {
                                    type: 'button',
                    ...
                    this.state.activeTab === 'users' && _react2.default.createElement(
                        'div',
                        { className: 'tab-pane active', id: 'users' },
                        _react2.default.createElement(
                            'table',
                            { className: 'table' },
                            _react2.default.createElement(
...
EditCompany.propTypes = {
    ...
    onChange: _propTypes2.default.func,
    errors: _propTypes2.default.object,
    users: _propTypes2.default.arrayOf(_propTypes2.default.object),
    onSave: _propTypes2.default.func.isRequired,
    onClose: _propTypes2.default.func.isRequired,
    onDelete: _propTypes2.default.func.isRequired,
    fetchCompanyUsers: _propTypes2.default.func.isRequired,
...
var _CompanyListItem = __webpack_require__(602);
...
function CompanyList(_ref) {
    var companies = _ref.companies,
        ...
        activeCompanyId = _ref.activeCompanyId;

    var list = companies.map(function (company) {
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'th',
                            null,
                            (0, _utils.gettext)('Superdesk Subscriber Id')
                        ),
                        _react2.default.createElement(
                            'th',
                            null,
                        ...
                        _react2.default.createElement(
                            'th',
                            null,
                            (0, _utils.gettext)('Contact')
                        ),
                        _react2.default.createElement(
                            'th',
                            null,
                            (0, _utils.gettext)('Telephone')
                        ),
                        _react2.default.createElement(
                            'th',
                            null,
                            (0, _utils.gettext)('Country')
                        ),
                        _react2.default.createElement(
                            'th',
                            null,
...
function CompanyListItem(_ref) {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            'td',
            null,
            company.sd_subscriber_id
        ),
        _react2.default.createElement(
            'td',
            null,
            company.is_enabled ? (0, _utils.gettext)('Enabled') : (0, _utils.gettext)('Disabled')
        ),
        _react2.default.createElement(
            'td',
            null,
        ...
        _react2.default.createElement(
            'td',
            null,
            (0, _utils.shortDate)(company._created)
        )
    );
}
