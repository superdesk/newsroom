...
var _CardMeta = __webpack_require__(178);
...
function CardFooter(_ref) {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(_CardMeta2.default, {
...
function CardBody(_ref) {
    var item = _ref.item,
        displayMeta = _ref.displayMeta,
        displayDescription = _ref.displayDescription,
        displaySource = _ref.displaySource;
    ...
    return _react2.default.createElement(
        ...
        displayDescription && _react2.default.createElement(
            'div',
        ...
        displayMeta && _react2.default.createElement(
            'div',
            { className: 'wire-articles__item__meta' },
            _react2.default.createElement(
                'div',
                ...
                displaySource && _react2.default.createElement(
                    'span',
                    null,
                    item.source,
                    ' ',
...
CardBody.propTypes = {
    item: _propTypes2.default.object,
    displayMeta: _propTypes2.default.bool,
    displayDescription: _propTypes2.default.bool,
    displaySource: _propTypes2.default.bool
};
...
function getItemActions(dispatch) {
    return [{
        ...
        action: function action(item) {
            return dispatch((0, _actions.previewAndCopy)(item));
        }
    }, {
...
exports.SET_ACTIVE = exports.OPEN_ITEM = exports.INIT_DATA = undefined;
...
function setActive(cardId) {
    return { type: SET_ACTIVE, cardId: cardId };
}
...
function CardMeta(_ref) {
    var wordCount = _ref.wordCount,
        pictureAvailable = _ref.pictureAvailable,
        source = _ref.source,
        versioncreated = _ref.versioncreated,
        displayDivider = _ref.displayDivider,
        slugline = _ref.slugline;
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            displayDivider && _react2.default.createElement('span', { className: 'wire-articles__item__divider' })
        ),
        _react2.default.createElement(
            'div',
            { className: 'wire-articles__item__meta-info' },
            slugline && _react2.default.createElement(
                'span',
                { className: 'bold' },
                slugline
            ),
...
CardMeta.propTypes = {
    ...
    source: _propTypes2.default.string,
    versioncreated: _propTypes2.default.string,
    displayDivider: _propTypes2.default.bool,
    slugline: _propTypes2.default.string
};
...
var _HomeApp = __webpack_require__(665);
...
var _PhotoGalleryCard = __webpack_require__(673);

var _PhotoGalleryCard2 = _interopRequireDefault(_PhotoGalleryCard);

var _EventsTwoByTwoCard = __webpack_require__(674);
...
var HomeApp = function (_React$Component) {
    ...
    function HomeApp(props, context) {
        ...
        _this.onHomeScroll = _this.onHomeScroll.bind(_this);
        _this.height = 0;
        return _this;
    }
    ...
    _createClass(HomeApp, [{
        ...
        key: 'onHomeScroll',
        value: function onHomeScroll(event) {
...
HomeApp.propTypes = {
    ...
    activeCard: _propTypes2.default.string,
    actions: _propTypes2.default.arrayOf(_propTypes2.default.shape({
        name: _propTypes2.default.string,
        action: _propTypes2.default.func
    }))
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    return {
        openItemDetails: function openItemDetails(item, cardId) {
            dispatch((0, _actions.openItemDetails)(item));
            dispatch((0, _actions.setActive)(cardId));
        },
...
var _CardRow = __webpack_require__(96);

var _CardRow2 = _interopRequireDefault(_CardRow);

var _CardFooter = __webpack_require__(112);
...
var getTextOnlyPanel = function getTextOnlyPanel(item, openItem, picture, cardId) {
    return _react2.default.createElement(
        'div',
        { key: item._id, className: 'col-sm-6 col-md-4 col-lg-3 col-xxl-2 d-flex mb-4' },
        _react2.default.createElement(
            'div',
            { className: 'card card--home', onClick: function onClick() {
                    return openItem(item, cardId);
                } },
            _react2.default.createElement(
                'div',
                { className: 'card-body' },
...
function TextOnlyCard(_ref) {
    ...
    return _react2.default.createElement(
        _CardRow2.default,
        { title: title, product: product, isActive: isActive },
        items.map(function (item) {
            return getTextOnlyPanel(item, openItem, (0, _utils2.getPicture)(item), cardId);
        })
    );
}
...
var _CardBody = __webpack_require__(138);
...
var getPictureTextPanel = function getPictureTextPanel(item, picture, openItem, withPictures, cardId) {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(_CardBody2.default, { item: item, displayMeta: false }),
            _react2.default.createElement(_CardFooter2.default, {
                wordCount: (0, _utils.wordCount)(item),
...
function PictureTextCard(_ref) {
    ...
    return _react2.default.createElement(
        ...
        { title: title, product: product, isActive: isActive },
        items.map(function (item) {
            return getPictureTextPanel(item, (0, _utils2.getPicture)(item), openItem, withPictures, cardId);
        })
    );
}
...
var getMediaPanel = function getMediaPanel(item, picture, openItem, cardId) {
...
function MediaGalleryCard(_ref) {
    ...
    return _react2.default.createElement(
        ...
        { title: title, product: product, isActive: isActive },
        items.map(function (item) {
            return getMediaPanel(item, (0, _utils2.getPicture)(item), openItem, cardId);
        })
    );
}
...
var getTopNewsPanel = function getTopNewsPanel(item, picture, openItem, cardId) {
...
function TopNewsOneByOneCard(_ref) {
    ...
    return _react2.default.createElement(
        ...
        { title: title, product: product, isActive: isActive },
        items.map(function (item) {
            return getTopNewsPanel(item, (0, _utils2.getPicture)(item), openItem, cardId);
        })
    );
}
...
var getTopNewsLeftPanel = function getTopNewsLeftPanel(item, picture, openItem, cardId) {
...
var getTopNewsRightPanel = function getTopNewsRightPanel(item, picture, openItem, cardId) {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement('img', { className: 'card-img-top', src: imageUrl, alt: caption }),
            _react2.default.createElement(_CardBody2.default, { item: item, displayDescription: false, displaySource: false }),
            _react2.default.createElement(_CardFooter2.default, {
                wordCount: (0, _utils.wordCount)(item),
                pictureAvailable: !!picture,
                source: item.source,
...
var getTopNews = function getTopNews(items, openItem, cardId) {
    var topNews = [];
    for (var i = 0; i < items.length; i += 2) {
        topNews.push(getTopNewsLeftPanel(items[i], (0, _utils2.getPicture)(items[i]), openItem, cardId));
        if (i + 1 < items.length) {
            topNews.push(getTopNewsRightPanel(items[i + 1], (0, _utils2.getPicture)(items[i + 1]), openItem, cardId));
        }
    }
    return topNews;
};
...
var getTextOnlyPanel = function getTextOnlyPanel(item, openItem, cardId) {
    return _react2.default.createElement(
        'div',
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(_CardBody2.default, { item: item, displaySource: false }),
            _react2.default.createElement(_CardFooter2.default, {
                wordCount: (0, _utils.wordCount)(item),
                pictureAvailable: !!(0, _utils2.getPicture)(item),
                source: item.source,
                versioncreated: item.versioncreated
            })
        )
...
function LargeTextOnlyCard(_ref) {
    ...
    return _react2.default.createElement(
        ...
        { title: title, product: product, isActive: isActive },
        items.map(function (item) {
            return getTextOnlyPanel(item, openItem, cardId);
        })
    );
}
...
var getPictureTextPanel = function getPictureTextPanel(item, picture, openItem, cardId) {
    var rendition = (0, _utils2.getThumbnailRendition)(picture);
    var imageUrl = rendition && rendition.href;
    var caption = rendition && (0, _utils2.getCaption)(picture);
...
function LargePictureTextCard(_ref) {
    ...
    return _react2.default.createElement(
        ...
        { title: title, product: product, isActive: isActive },
        items.map(function (item) {
            return getPictureTextPanel(item, (0, _utils2.getPicture)(item), openItem, cardId);
        })
    );
}
...
var _MoreNewsButton = __webpack_require__(177);
...
var getEventPanel = function getEventPanel(event, index) {
    ...
    var isSameMonth = function isSameMonth(d1, d2) {
        return !!d2 && d1.format('MMMM') === d2.format('MMMM');
    };

    var isDifferentMonth = function isDifferentMonth(d1, d2) {
        return !!d2 && d1.format('MMMM') !== d2.format('MMMM');
    };

    // Checks if the date range is for the whole month
    var isWholeMonth = function isWholeMonth(d1, d2) {
        if (!d2) {
            return false;
        }
        var date1 = (0, _moment2.default)(d1),
            date2 = (0, _moment2.default)(d2);
        return date1.format('MMMM') === date2.format('MMMM') && date1.format('MMMM') !== date2.add(1, 'days').format('MMMM') && date1.add(-1, 'days').format('MMMM') !== date2.format('MMMM');
    };

    var getDateSpans = function getDateSpans(d1, d2) {
        return [isWholeMonth(d1, d2) ? _react2.default.createElement(
            'div',
            { key: 'day', className: 'date-round__number' },
            _react2.default.createElement(
                'span',
                null,
                (0, _utils.gettext)('all')
            )
        ) : _react2.default.createElement(
            'div',
            { key: 'day', className: 'date-round__number' },
            ...
            _react2.default.createElement(
                'span',
                null,
                isSameMonth(d1, d2) && d2.format('D')
            )
        ), _react2.default.createElement(
            'div',
            { key: 'month', className: 'date-round__month date-round__month--big' },
            _react2.default.createElement(
                'span',
                null,
                d1.format('MMMM')
            )
        ), isDifferentMonth(d1, d2) ? _react2.default.createElement(
            'div',
            { key: 'month2', className: 'date-round__month' },
            (0, _utils.gettext)('to'),
            ' ',
            _react2.default.createElement(
                'span',
                { className: 'date-round__number--small' },
                d2.format('D')
            ),
            '  ',
            _react2.default.createElement(
    ...
    var getDate = function getDate() {
        ...
        var endDate = event.endDate ? (0, _moment2.default)(event.endDate) : null;
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'span',
                                { className: 'wire-articles__item__icon' },
                                _react2.default.createElement('i', { className: 'icon--calendar icon--gray-light' })
                            )
                        ),
                        _react2.default.createElement(
                            'div',
...
var CardRow = function (_React$Component) {
    ...
    function CardRow(props) {
        ...
        return _possibleConstructorReturn(this, (CardRow.__proto__ || Object.getPrototypeOf(CardRow)).call(this, props));
    }
    ...
    _createClass(CardRow, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: 'row', ref: function ref(elem) {
                        return _this2.cardElem = elem;
                    } },
                _react2.default.createElement(_MoreNewsButton2.default, {
