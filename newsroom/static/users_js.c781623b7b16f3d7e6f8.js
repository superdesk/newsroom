...
exports.SET_ERROR = exports.GET_COMPANIES = exports.GET_USERS = exports.QUERY_USERS = exports.SET_QUERY = exports.CANCEL_EDIT = exports.NEW_USER = exports.EDIT_USER = exports.SELECT_USER = undefined;
...
function newUser(data) {
    return { type: NEW_USER, data: data };
}
...
var QUERY_USERS = exports.QUERY_USERS = 'QUERY_USERS';
function queryUsers() {
...
function fetchUsers() {
    return function (dispatch, getState) {
        ...
        return _server2.default.get('/users/search?q=' + query).then(function (data) {
...
function postUser() {
    return function (dispatch, getState) {
        ...
        var user = getState().userToEdit;
        var url = '/users/' + (user._id ? user._id : 'new');

        return _server2.default.post(url, user).then(function () {
            if (user._id) {
                _utils.notify.success((0, _utils.gettext)('User updated successfully'));
            } else {
                _utils.notify.success((0, _utils.gettext)('User created successfully'));
            }
            dispatch(fetchUsers());
        }).catch(function (error) {
            return (0, _utils.errorHandler)(error, dispatch, setError);
...
function resetPassword() {
    return function (dispatch, getState) {
        ...
        var user = getState().userToEdit;
        var url = '/users/' + user._id + '/reset_password';

        return _server2.default.post(url, {}).then(function () {
            return _utils.notify.success((0, _utils.gettext)('Reset password token is sent successfully'));
        }).catch(function (error) {
            return (0, _utils.errorHandler)(error, dispatch, setError);
        });
    };
...
function deleteUser() {
    return function (dispatch, getState) {
        ...
        return _server2.default.del(url).then(function () {
            _utils.notify.success((0, _utils.gettext)('User deleted successfully'));
            dispatch(fetchUsers());
        }).catch(function (error) {
            return (0, _utils.errorHandler)(error, dispatch, setError);
        });
...
var _reducers = __webpack_require__(602);

var _reducers2 = _interopRequireDefault(_reducers);

var _UsersApp = __webpack_require__(603);
...
(0, _utils.render)(store, _UsersApp2.default, document.getElementById('settings-app'));
        ...
        case _actions.EDIT_USER:
            {
                ...
                var user = state.userToEdit;
                user[field] = target.type === 'checkbox' ? target.checked : target.value;
                return _extends({}, state, { userToEdit: user, errors: null });
            }
        ...
        case _actions.NEW_USER:
            {
                ...
                return _extends({}, state, { userToEdit: newUser, errors: null });
            }

        case _actions.CANCEL_EDIT:
            {
                return _extends({}, state, { userToEdit: null, errors: null });
            }
        ...
        case _actions.GET_USERS:
            {
                ...
                var users = action.data.map(function (user) {
                    usersById[user._id] = user;
                    return user._id;
                });

                return _extends({}, state, { users: users, usersById: usersById, isLoading: false, totalUsers: users.length });
            }
...
var _Users = __webpack_require__(604);
...
var UsersApp = function (_React$Component) {
    ...
    function UsersApp(props, context) {
        _classCallCheck(this, UsersApp);

        return _possibleConstructorReturn(this, (UsersApp.__proto__ || Object.getPrototypeOf(UsersApp)).call(this, props, context));
    }
    ...
    _createClass(UsersApp, [{
        ...
        value: function render() {
            return [_react2.default.createElement(_ListBar2.default, {
                ...
                buttonName: 'User'
            }), _react2.default.createElement(_Users2.default, { key: 'Users' })];
        }
    }]);
...
UsersApp.propTypes = {
    ...
    userToEdit: _propTypes2.default.object,
    activeUserId: _propTypes2.default.string,
    selectUser: _propTypes2.default.func,
    editUser: _propTypes2.default.func,
    saveUser: _propTypes2.default.func,
    deleteUser: _propTypes2.default.func,
    newUser: _propTypes2.default.func,
    resetPassword: _propTypes2.default.func,
    cancelEdit: _propTypes2.default.func,
    isLoading: _propTypes2.default.bool,
    activeQuery: _propTypes2.default.string,
    totalUsers: _propTypes2.default.number,
    companies: _propTypes2.default.arrayOf(_propTypes2.default.object),
    companiesById: _propTypes2.default.object,
    usersById: _propTypes2.default.object,
...
exports.default = (0, _reactRedux.connect)(null, mapDispatchToProps)(UsersApp);
...
var _EditUser = __webpack_require__(605);

var _EditUser2 = _interopRequireDefault(_EditUser);

var _UsersList = __webpack_require__(606);
...
var Users = function (_React$Component) {
    ...
    _createClass(Users, [{
        ...
        value: function deleteUser(event) {
            ...
            confirm((0, _utils.gettext)('Would you like to delete user: {{name}}?', { name: this.props.userToEdit.first_name })) && this.props.deleteUser('users');
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                this.props.userToEdit && _react2.default.createElement(_EditUser2.default, {
...
var mapStateToProps = function mapStateToProps(state) {
    return {
        users: state.users.map(function (id) {
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    return {
        selectUser: function selectUser(_id) {
            return dispatch((0, _actions.selectUser)(_id));
        },
        editUser: function editUser(event) {
            return dispatch((0, _actions.editUser)(event));
        },
        saveUser: function saveUser(type) {
            return dispatch((0, _actions.postUser)(type));
        },
        deleteUser: function deleteUser(type) {
            return dispatch((0, _actions.deleteUser)(type));
        },
        newUser: function newUser(data) {
            return dispatch((0, _actions.newUser)(data));
        },
...
var userTypes = [{ value: 'administrator', text: (0, _utils.gettext)('Administrator') }, { value: 'internal', text: (0, _utils.gettext)('Internal') }, { value: 'public', text: (0, _utils.gettext)('Public') }];

var getCompanyOptions = function getCompanyOptions(companies) {
    return companies.map(function (company) {
        return { value: company._id, text: company.name };
    });
};
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                ...
                _react2.default.createElement(_SelectInput2.default, {
                    name: 'user_type',
                    label: (0, _utils.gettext)('User Type'),
                ...
                _react2.default.createElement(_SelectInput2.default, {
                    name: 'company',
                    label: (0, _utils.gettext)('Company'),
                    value: user.company,
                    defaultOption: '',
                ...
                _react2.default.createElement(_CheckboxInput2.default, {
                    name: 'is_approved',
                    label: (0, _utils.gettext)('Approved'),
            ...
            _react2.default.createElement(
                ...
                user._id ? _react2.default.createElement('input', {
                    type: 'button',
                    className: 'btn btn-outline-secondary',
                    value: (0, _utils.gettext)('Reset Password'),
                    id: 'resetPassword',
...
var _UserListItem = __webpack_require__(607);
...
function UsersList(_ref) {
    var users = _ref.users,
        ...
        companiesById = _ref.companiesById;
...
function UserListItem(_ref) {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            'td',
            null,
            user.company && companiesById ? companiesById[user.company].name : null
        ),
        _react2.default.createElement(
            'td',
            null,
            user.is_approved ? (0, _utils.gettext)('Approved') : (0, _utils.gettext)('Needs Approval'),
            ' -',
            user.is_enabled ? (0, _utils.gettext)('Enabled') : (0, _utils.gettext)('Disabled')
        ),
        _react2.default.createElement(
            'td',
            null,
